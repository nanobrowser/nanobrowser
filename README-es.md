...
Browseless AI es una herramienta de automatización web con IA que se ejecuta en tu navegador. Es una alternativa gratuita a OpenAI Operator, con opciones flexibles de modelos de lenguaje (LLM) y un sistema multiagente.

⬇️ Descarga [Browseless AI desde Chrome Web Store](https://chromewebstore.google.com/detail/nanobrowser/imbddededgmcgfhfpcjmijokokekbkal) gratis

👏 Únete a la comunidad en [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/nanobrowser_ai)

❤️ ¿Te encanta Browseless AI? ¡Danos una estrella 🌟 y ayúdanos a correr la voz!
...
<p><em>El sistema multiagente de Browseless AI analizando HuggingFace en tiempo real, con el Planner autocorrigiéndose de forma inteligente al enfrentar obstáculos e instruyendo dinámicamente al Navigator para ajustar su enfoque, todo ejecutándose localmente en tu navegador.</em></p>
</div>

## 🔥 ¿Por qué usar Browseless AI?

¿Buscas un potente agente de navegador con IA sin el precio de $200/mes de OpenAI Operator? **Browseless AI**, como extensión de Chrome, ofrece capacidades avanzadas de automatización web mientras tú tienes el control total.
...
1. **Instala desde Chrome Web Store** (Versión Estable):
   * Visita la [página de Browseless AI en Chrome Web Store](https://chromewebstore.google.com/detail/nanobrowser/imbddededgmcgfhfpcjmijokokekbkal)
...
2. **Configurar Modelos de Agente**:
   * Haz clic en el icono de Browseless AI ubicado en la barra de herramientas para abrir el panel lateral
...
3. **Configurar Modelos de Agente**
    * Haz clic en el icono de Browseless AI en la barra de herramientas para abrir el panel lateral
    * Haz clic en el icono de `Settings` (arriba a la derecha).
    * Agrega tus claves de API del LLM
    * Elige qué modelo usar para cada agente (Navigator, Planner)
...
4. **Actualizar**:
    ...
    * Extrae y reemplaza los archivos existentes de Browseless AI con los nuevos.
    * Ve a `chrome://extensions/` en Chrome y haz clic en el icono de actualizar en la tarjeta de Browseless AI.

## 🛠️ Compilar desde el Código Fuente

Si prefieres compilar Browseless AI por ti mismo, sigue estos pasos:
...
Browseless AI te permite configurar distintos modelos LLM para cada agente para equilibrar costo y rendimiento. Aquí están las configuraciones recomendadas:
...
Estamos desarrollando activamente Browseless AI con características emocionantes en el horizonte. ¡Te invitamos a unirte!
...
**Necesitamos tu ayuda para hacer que Browseless AI sea aún mejor!**  Se aceptan contribuciones de todo tipo:

*  **Comparte Prompts y Casos de Uso** 
   * Únete a nuestro [servidor de Discord](https://discord.gg/NN3ABHggMK).
   * Comparte cómo estás usando Browseless AI. Ayúdanos a construir una biblioteca de prompts útiles y casos de uso reales.
*  **Proporciona Retroalimentación** 
   * Prueba Browseless AI y danos tu opinión sobre su rendimiento o sugiere mejoras en nuestro [servidor de Discord](https://discord.gg/NN3ABHggMK).
...
¡Agradecemos tu ayuda para mantener Browseless AI y sus usuarios seguros!
...
Browseless AI se construye sobre otros increíbles proyectos de código abierto:
...
Hecho con ❤️ por el equipo de Browseless AI.

¿Te gusta Browseless AI? ¡Danos una estrella 🌟 y únete a nosotros en [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/nanobrowser_ai)
