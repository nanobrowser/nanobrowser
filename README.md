...
Browseless AI is an open-source AI web automation tool that runs in your browser. A free alternative to OpenAI Operator with flexible LLM options and multi-agent system.

⬇️ Get [Browseless AI from Chrome Web Store](https://chromewebstore.google.com/detail/nanobrowser/imbddededgmcgfhfpcjmijokokekbkal) for free

👏 Join the community in [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/nanobrowser_ai)

🌟 Loving Browseless AI? Give us a star  and help spread the word!

❤️ Support the project by [sponsoring us](https://github.com/sponsors/alexchenzl) - every contribution helps keep Browseless AI free and open source!
...
<p><em>Browseless AI's multi-agent system analyzing HuggingFace in real-time, with the Planner intelligently self-correcting when encountering obstacles and dynamically instructing the Navigator to adjust its approach—all running locally in your browser.</em></p>
</div>

## 🔥Why Browseless AI?

Looking for a powerful AI browser agent without the $200/month price tag of OpenAI Operator? **Browseless AI** , as a chrome extension, delivers premium web automation capabilities while keeping you in complete control:
...
> **Note**: While Browseless AI may function on other Chromium-based browsers, we recommend using Chrome or Edge for the best experience and guaranteed compatibility.


## 🚀 Quick Start

1. **Install from Chrome Web Store** (Stable Version):
   * Visit the [Browseless AI Chrome Web Store page](https://chromewebstore.google.com/detail/nanobrowser/imbddededgmcgfhfpcjmijokokekbkal)
...
2. **Configure Agent Models**:
   * Click the Browseless AI icon in your toolbar to open the sidebar
...
4. **Upgrading**:
    ...
    * Unzip and replace your existing Browseless AI files with the new ones.
    * Go to `chrome://extensions/` in Chrome and click the refresh icon on the Browseless AI card.

## 🛠️ Build from Source

If you prefer to build Browseless AI yourself, follow these steps:
...
Browseless AI allows you to configure different LLM models for each agent to balance performance and cost. Here are recommended configurations:
...
We're actively developing Browseless AI with exciting features on the horizon, welcome to join us! 
...
**We need your help to make Browseless AI even better!**  Contributions of all kinds are welcome:

*  **Share Prompts & Use Cases** 
   * Join our [Discord server](https://discord.gg/NN3ABHggMK).
   * share how you're using Browseless AI.  Help us build a library of useful prompts and real-world use cases.
*  **Provide Feedback** 
   * Try Browseless AI and give us feedback on its performance or suggest improvements in our [Discord server](https://discord.gg/NN3ABHggMK).
* **Contribute Code**
...
We appreciate your help in keeping Browseless AI and its users safe!
...
Browseless AI builds on top of other awesome open-source projects:
...
Made with ❤️ by the Browseless AI Team. 

Like Browseless AI? Give us a star 🌟 and join us in [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/nanobrowser_ai)
...
**Any such derivative projects are NOT Affiliated with, or maintained by, or in any way connected to the official Browseless AI project or its core team.**
