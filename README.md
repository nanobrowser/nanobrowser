...
CloudCerebro is an open-source AI web automation tool that runs in your browser. A free alternative to OpenAI Operator with flexible LLM options and multi-agent system.

⬇️ Get [CloudCerebro from Chrome Web Store](https://chromewebstore.google.com/detail/nanobrowser/imbddededgmcgfhfpcjmijokokekbkal) for free

👏 Join the community in [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/nanobrowser_ai)

❤️ Loving CloudCerebro? Give us a star 🌟 and help spread the word!
...
<p><em>CloudCerebro's multi-agent system analyzing HuggingFace in real-time, with the Planner intelligently self-correcting when encountering obstacles and dynamically instructing the Navigator to adjust its approach—all running locally in your browser.</em></p>
</div>

## 🔥Why CloudCerebro?

Looking for a powerful AI web agent without the $200/month price tag of OpenAI Operator? **CloudCerebro** , as a chrome extension, delivers premium web automation capabilities while keeping you in complete control:
...
> **Note**: While CloudCerebro may function on other Chromium-based browsers, we recommend using Chrome or Edge for the best experience and guaranteed compatibility.


## 🚀 Quick Start

1. **Install from Chrome Web Store** (Stable Version):
   * Visit the [CloudCerebro Chrome Web Store page](https://chromewebstore.google.com/detail/nanobrowser/imbddededgmcgfhfpcjmijokokekbkal)
...
2. **Configure Agent Models**:
   * Click the CloudCerebro icon in your toolbar to open the sidebar
...
1. **Download**
    * Download the latest `cloudcerebro.zip` file from the official Github [release page](https://github.com/nanobrowser/nanobrowser/releases).

2. **Install**:
    * Unzip `cloudcerebro.zip`.
    * Open `chrome://extensions/` in Chrome
    * Enable `Developer mode` (top right)
    * Click `Load unpacked` (top left)
    * Select the unzipped `cloudcerebro` folder.
...
4. **Upgrading**:
    * Download the latest `cloudcerebro.zip` file from the release page.
    * Unzip and replace your existing CloudCerebro files with the new ones.
    * Go to `chrome://extensions/` in Chrome and click the refresh icon on the CloudCerebro card.

## 🛠️ Build from Source

If you prefer to build CloudCerebro yourself, follow these steps:
...
CloudCerebro allows you to configure different LLM models for each agent to balance performance and cost. Here are recommended configurations:
...
We're actively developing CloudCerebro with exciting features on the horizon, welcome to join us! 
...
**We need your help to make CloudCerebro even better!**  Contributions of all kinds are welcome:

*  **Share Prompts & Use Cases** 
   * Join our [Discord server](https://discord.gg/NN3ABHggMK).
   * share how you're using CloudCerebro.  Help us build a library of useful prompts and real-world use cases.
*  **Provide Feedback** 
   * Try CloudCerebro and give us feedback on its performance or suggest improvements in our [Discord server](https://discord.gg/NN3ABHggMK).
* **Contribute Code**
...
We appreciate your help in keeping CloudCerebro and its users safe!
...
CloudCerebro builds on top of other awesome open-source projects:
...
Made with ❤️ by the CloudCerebro Team. 

Like CloudCerebro? Give us a star 🌟 and join us in [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/nanobrowser_ai)
