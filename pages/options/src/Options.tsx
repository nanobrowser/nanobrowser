...
import { FiSettings, FiCpu, FiShield, FiTrendingUp, FiHelpCircle, FiServer } from 'react-icons/fi';
...
type TabTypes = 'general' | 'models' | 'firewall' | 'analytics' | 'rag' | 'websocket' | 'help';
...
const TABS: { id: TabTypes; icon: React.ComponentType<{ className?: string }>; label: string }[] = [
  ...
  { id: 'websocket', icon: FiServer, label: 'WebSocket' },
