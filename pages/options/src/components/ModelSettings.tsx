              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className={`w-20 rounded-md border ${
                    isDarkMode
                      ? 'border-slate-600 bg-[#f7f7f7] text-[#333333] focus:border-blue-500 focus:ring-2 focus:ring-blue-800'
                      : 'border-gray-300 bg-[#f7f7f7] text-[#333333] focus:border-blue-400 focus:ring-2 focus:ring-blue-200'
                  } px-2 py-1 text-sm`}
                ...
                <div
                  ...
                  <div className="space-y-3">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border p-2 text-sm ${
                              nameErrors[providerId]
                                ? isDarkMode
                                  ? 'border-red-700 bg-[#f7f7f7] text-[#333333] focus:border-red-600 focus:ring-2 focus:ring-red-900'
                                  : 'border-red-300 bg-[#f7f7f7] text-[#333333] focus:border-red-400 focus:ring-2 focus:ring-red-200'
                                : isDarkMode
                                  ? 'border-blue-700 bg-[#f7f7f7] text-[#333333] focus:border-blue-600 focus:ring-2 focus:ring-blue-900'
                                  : 'border-blue-300 bg-[#f7f7f7] text-[#333333] focus:border-blue-400 focus:ring-2 focus:ring-blue-200'
                            } outline-none`}
                          />
                        </div>
                        {nameErrors[providerId] ? (
                    ...
                    {(providerConfig.type as ProviderTypeEnum) === ProviderTypeEnum.AzureOpenAI && (
                      ...
                      className="min-w-[150px] flex-1 border-none bg-[#f7f7f7] p-1 text-sm text-[#333333] outline-none"
                    />
                          </div>
